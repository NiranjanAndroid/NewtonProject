 ...
 */
public class GetMessageNetwork implements com.android.volley.Response.Listener, com.android.volley.Response.ErrorListener {
    ...
    public GetMessageNetwork(Activity activity, int eventType, String id) {
        mActivity = activity;
